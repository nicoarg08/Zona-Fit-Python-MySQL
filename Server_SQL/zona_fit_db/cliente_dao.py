from Server_SQL.zona_fit_db.conexion import Conexion
...
class ClienteDAO:
    ...
    def seleccionar(cls):
        ...
        try:
            ...
            cursor.execute(cls.SELECCIONAR)# Selecciona todo los
            ...
            print(f"Ocurrio un error al seleccionar cleintes: {e}")
        finally:
    ...
    def insertar(cls,cliente):
        ...
        try:
            ...
            conexion.commit()
            return cursor.rowcout # Indica cuantas variables se modificaron en BST
        except Exception as e:
    ...
    @classmethod
    def actualizar(cls,cliente): # Ya debe tener ID establecido
        conexion = None
        try:
            conexion = Conexion.obtener_conexion()
            cursor = conexion.cursor()
...
if __name__ == "__main__":
    # Insertar cliente
    # cliente1 = Cliente(nombre="Alejandra",apellido="Leyes",membresia=300)
    # clientes_insertados = CLienteDAO.insertar(cliente1)
    # print(f"Cliente insertados: {clientes_insertados}")
